...
in
{
  ...
  options = {
    services.dunst = {
      ...
      additionalCategories = mkOption {
        type = types.listOf types.str;
        default = [ ];
        example = [ "panel" ];
        description = "Any additional icon categories to inclue.";
      };
  ...
  config = mkIf cfg.enable (mkMerge [
    {
      assertions = [ (hm.assertions.assertPlatform "services.dunst" pkgs platforms.linux) ];
      ...
      services.dunst.settings.global.icon_path =
        let
          ...
          mkPath =
            ...
            "${basePath}/share/icons/${theme.name}/${category}/${theme.size}/"; # Changed for Gruvbox-Plus-Dark
        in
